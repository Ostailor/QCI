...
These exports are offline build artifacts. They do not require live QCi
...
def build_polynomial_model_payload(model: PolynomialModel, metadata: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "scaling_information": {
            ...
            "note": "Scaling metadata is retained so hardware adapters can rescale coefficients for QCi APIs.",
        },
        "model_statistics": statistics,
        "execution_notice": "Pre-QCi artifact generated without a hardware submission; no hardware advantage is implied.",
    }
...
def build_qci_payload(hamiltonian: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "execution_notice": "Offline pre-QCi payload only.",
    }
