"""Deterministic synthetic fixtures for CMPO unit tests and smoke checks.

The generated case is designed for local reproducibility. It is
...
def generate_synthetic_dataset(
    ...
    case = GridCase(
        ...
        documentation=(
            "Synthetic CMPO test fixture. Values use plausible ranges for small "
