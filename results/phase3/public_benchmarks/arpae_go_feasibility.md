...
- Local data directory: data/upstream/arpae-go

## Download And Local Availability
- Download status: manifest_downloaded
- Download URL: https://data.openei.org/files/6153/Challenge_1_Original_Dataset_2_Scenarios.zip
- Local archive: data/upstream/arpae-go/archives/Challenge_1_Original_Dataset_2_Scenarios.zip
...
## Parse Result
- Can be parsed: yes
- Sample parsed: data/upstream/arpae-go/extracted/Challenge_1_Original_Dataset_2_Scenarios/Original_Dataset_Offline_Edition_2/Network_01O-020/scenario_1/case.raw

```json
{
  "can_parse": true,
  "path": "data/upstream/arpae-go/extracted/Challenge_1_Original_Dataset_2_Scenarios/Original_Dataset_Offline_Edition_2/Network_01O-020/scenario_1/case.raw",
