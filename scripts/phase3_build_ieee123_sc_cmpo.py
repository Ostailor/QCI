...
DEFAULT_OUTPUT = Path("results/phase3/reproduced/sc_cmpo/ieee123")
DEFAULT_PROVENANCE = Path("results/phase3/reproduced/sc_cmpo/public_benchmark_provenance.csv")
DEFAULT_VALIDATION = Path("results/phase3/reproduced/sc_cmpo/distribution_validation.md")
